import { commonModule, authModule, usersModule, settingsModule, supportModule, identificationModule, shopModule, paymentModule } from './store'
...
export default {
  install (Vue, options) {
    ...
    store.registerModule('sanadmin/payment', paymentModule)
